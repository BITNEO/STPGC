...
def index_to_mask(index, size):
    ...
    mask[index] = 1
    return mask
embedding_dim_dict = {'Cora': [1433, 512, 7], 'Citeseer': [3703, 512, 6], 'pubmed': [500, 512, 3], 'ogbn-arxiv': [128, 256, 40],'dblp': [128, 512, 4],'reddit': [602, 512, 41],'ogbn-products': [128, 256, 47]}
...
if __name__ == '__main__':
    ...
    for dataname in ['Cora']:
            ...
            # for v in [ 0.9]:
                    ...
                    args.hidden = embedding_dim_dict[dataname][1]
                    ...
                    data_mol, m = np.load('./Reduced_Node_Data/%s_%.2f_split_All_Simplex.npy' % (dataname, v), allow_pickle=True)
                    ...
                    f = open('/home/wuxiang/GEC-main/parameter_experiment.txt', 'a')
                    #f.write('%d  %.2f\n' %  (rank, v))
